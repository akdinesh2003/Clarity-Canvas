...
/**
 * @fileOverview Summarizes feedback collected via feedback pins to efficiently understand the main points of critique and improve layout.
 *
...
const SummarizeFeedbackInputSchema = z.object({
  feedback: z.array(z.string()).describe('An array of feedback strings collected from feedback pins.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert at summarizing feedback for UI/UX design.

  Summarize the following feedback to provide the most important points of critique. Be concise and direct.

  Feedback: {{#each feedback}}{{{this}}}\n{{/each}}`,
});
